...
const PRODUCT_ONE = new Product("prod1", "Test product 1", 10.0);
const PRODUCT_TWO = new Product("prod2", "Test product 2", 15.5);
...
describe(Cart, () => {
  ...
  describe("countItems()", () => {
    ...
    test("is one when one item is in the cart", () => {
      const cart = new Cart();
      cart.addItem(
        new Item(new Product("ESP250", "Espresso Blend, 250g", 14.0))
      );
